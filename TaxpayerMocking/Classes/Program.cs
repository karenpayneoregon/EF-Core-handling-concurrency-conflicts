...
internal partial class Program
{
    ...
    private static string PromptStyleColor { get; set; } = "cyan";
    private static string PromptColor { get; set; } = "b";
    private static bool GetYesNo(string text)
    {
        return AnsiConsole.Prompt(
            new TextPrompt<bool>($"[{PromptColor}]{text}[/]:").PromptStyle(PromptStyleColor).DefaultValue(false));
    }
}